...
class RemindersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reminder" do
    assert_difference("Reminder.count") do
      post reminders_url, params: { reminder: { date: @reminder.date, name: @reminder.name, reminder_type: @reminder.reminder_type, repetition: @reminder.repetition, user_id: @reminder.user_id } }
    end
  ...
  test "should update reminder" do
    patch reminder_url(@reminder), params: { reminder: { date: @reminder.date, name: @reminder.name, reminder_type: @reminder.reminder_type, repetition: @reminder.repetition, user_id: @reminder.user_id } }
